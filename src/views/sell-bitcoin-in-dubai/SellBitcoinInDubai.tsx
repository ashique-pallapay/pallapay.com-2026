...
export function SellBitcoinInDubai({prices = {}}: {prices?: {[key: string]: {
    ...
    return (
        <>
                        ...
                        <div className="col-span-12 md:col-span-7 text-center md:pl-10">
                            <div>
                                <h1 className="text-3xl leading-[2.8rem] lg:text-4xl lg:leading-[3.7rem] font-semibold">
                                    Sell Bitcoin in Dubai<br/>Get Cash or Bank Transfer
                                </h1>
                            </div>
            ...
            <Calculator symbol="BTC" prices={prices} />
            ...
            <div className="container mt-20! text-black">
                ...
                <h4 className="text-2xl font-semibold text-center mt-10">How to sell Bitcoin and Receive Cash in Dubai
                    UAE?</h4>
                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mt-12">
                        ...
                        <InteractiveGradientCard className="bg-neutral-300 flex items-center justify-center pb-4 pt-1">
                            ...
                            <p className="mt-2">Payouts occur immediately after we receive your Bitcoin inu</p>
                        </InteractiveGradientCard>
                        <InteractiveGradientCard className="bg-neutral-300 flex items-center justify-center pb-4 pt-1">
                            <div
                        ...
                        <div className="flex items-center row-start-2 md:row-start-1">
                            <div>
                                ...
                                <div className="space-y-2 mt-2">
                                    <p>Bitcoin is a digital currency which operates free of any central control or the oversight of banks or governments. Instead it relies on peer-to-peer software and cryptography.</p>
                                    <p>Bitcoin was created as a way for people to send money over the internet. The digital currency was intended to provide an alternative payment system that would operate free of central control but otherwise be used just like traditional currencies.</p>
                                </div>
                                <h3 className="text-2xl font-semibold mt-4">Can bitcoin be converted to cash?</h3>
                                <div className="space-y-2">
                                    <p>Yes Bitcoin can be exchanged for cash just like any other cryptocurrency in Pallapay branches in Dubai.</p>
                                </div>
                                <ParallaxProvider>
            ...
            <div className="my-14! container text-black">
                ...
                <Accordion type="single" collapsible className="w-full border-b mt-6">
                    ...
                    <AccordionItem value="item-7">
                        ...
                        <AccordionContent>
                            <a href="https://www.pallapay.com/buy-sell-bitcoin-tether-dubai"
                               ...
                               title="Sell Online">Yes You Can Sell Online And Get Cash Or Bank Transfer By Visiting The Sell Page, or by Downloading our APP. Also Available on Our OTC (Over the Counter) exchange.</a>
                        </AccordionContent>
                    </AccordionItem>
                    ...
                    <AccordionItem value="item-10">
                        <AccordionTrigger>Do you provide receipt when i sell my Bitcoin in your Dubai store?</AccordionTrigger>
                        <AccordionContent>
            ...
            <div className="container mt-20! mb-5! text-black">
                <div className="bg-white rounded-3xl p-10 shadow-[0_0px_40px_rgba(0,0,0,0.05)] space-y-3">
                    <h3 className="text-xl font-semibold">
                        Pallapay is the best place to sell Bitcoin and other Cryptocurrency and get cash instantly in Dubai UAE. Pallapay is an international brand providing cryptocurrency exchange services. Currently, it operates in four (4) different countries and major cities: Dubai, USA, Singapore, and Istanbul. Since 2015, thousands of people have relied on Pallapay to exchange their cryptocurrencies for cash and vice versa.
                    </h3>
                </div>
            </div>
